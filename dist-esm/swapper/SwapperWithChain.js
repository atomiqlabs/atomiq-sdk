...
export class SwapperWithChain {
    ...
    constructor(swapper, chainIdentifier) {
        ...
        this.prices = new SwapPriceWithChain(swapper.prices, chainIdentifier);
    }
    /**
    ...
    getToken(tickerOrAddress) {
        ...
        if (tickerOrAddress.includes("-")) {
            ...
            if (chainId !== this.chainIdentifier)
                throw new UserError(`Invalid chainId specified in ticker: ${chainId}, swapper chainId: ${this.chainIdentifier}`);
    ...
    getSupportedTokens(_swapType) {
        ...
        this.intermediaryDiscovery.intermediaries.forEach(lp => {
            ...
            if (swapType === SwapType.FROM_BTCLN && this.supportsSwapType(SwapType.FROM_BTCLN_AUTO))
                swapType = SwapType.FROM_BTCLN_AUTO;
            if (swapType === SwapType.FROM_BTC && this.supportsSwapType(SwapType.SPV_VAULT_FROM_BTC))
     ...
     */
    withSigner(signer) {
        return new SwapperWithSigner(this, signer);
    }
}
