 ...
 * @category Swaps/Smart chain → Bitcoin
 */
export class IToBTCSwap extends IEscrowSelfInitSwap {
    ...
    getSwapFee() {
        ...
        const amountInDstToken = toTokenAmount(this.swapFeeBtc, this.outputToken, this.wrapper._prices, this.pricingInfo);
        return {
     ...
     */
    getNetworkFee() {
        const amountInDstToken = toTokenAmount(this.networkFeeBtc, this.outputToken, this.wrapper._prices, this.pricingInfo);
        return {
            amountInSrcToken: toTokenAmount(this.networkFee, this.wrapper._tokens[this._data.getToken()], this.wrapper._prices, this.pricingInfo),
            amountInDstToken,
            currentUsdValue: amountInDstToken.currentUsdValue,
            usdValue: amountInDstToken.usdValue,
            pastUsdValue: amountInDstToken.pastUsdValue
     ...
     */
    getFee() {
        const amountInDstToken = toTokenAmount(this.swapFeeBtc + this.networkFeeBtc, this.outputToken, this.wrapper._prices, this.pricingInfo);
        return {
            amountInSrcToken: toTokenAmount(this.swapFee + this.networkFee, this.wrapper._tokens[this._data.getToken()], this.wrapper._prices, this.pricingInfo),
            amountInDstToken,
            currentUsdValue: amountInDstToken.currentUsdValue,
            usdValue: amountInDstToken.usdValue,
            pastUsdValue: amountInDstToken.pastUsdValue
     ...
     */
    getInput() {
        return toTokenAmount(this._data.getAmount(), this.wrapper._tokens[this._data.getToken()], this.wrapper._prices, this.pricingInfo);
    }
    /**
     * @inheritDoc
     */
    getInputWithoutFee() {
        return toTokenAmount(this._data.getAmount() - (this.swapFee + this.networkFee), this.wrapper._tokens[this._data.getToken()], this.wrapper._prices, this.pricingInfo);
    }
    /**
    ...
    async waitTillIntermediarySwapProcessed(checkIntervalSeconds, abortSignal) {
        ...
        let resp = { code: RefundAuthorizationResponseCodes.PENDING, msg: "" };
        while (!abortSignal?.aborted && (resp.code === RefundAuthorizationResponseCodes.PENDING || resp.code === RefundAuthorizationResponseCodes.NOT_FOUND)) {
            ...
            if (resp.code === RefundAuthorizationResponseCodes.PENDING ||
    ...
    async getRefundNetworkFee() {
        ...
        return toTokenAmount(await swapContract.getRefundFee(this._getInitiator(), this._data), this.wrapper._getNativeToken(), this.wrapper._prices);
    }
    /**
     * @inheritDoc
     *
