...
export function isOnchainForGasSwapInit(obj) {
 ...
 * @category Swaps/Trusted Gas Swaps
 */
export class OnchainForGasSwap extends ISwap {
     ...
     */
    getInputWithoutFee() {
        return toTokenAmount(this.inputAmount - (this.swapFeeBtc ?? 0n), BitcoinTokens.BTC, this.wrapper._prices, this.pricingInfo);
    }
    /**
    ...
    getSwapFee() {
        ...
        const amountInSrcToken = toTokenAmount(this.swapFeeBtc ?? 0n, BitcoinTokens.BTC, this.wrapper._prices, this.pricingInfo);
        return {
            amountInSrcToken,
