...
exports.SpvFromBTCSwapBase = exports.isSpvFromBTCSwapInit = exports.SpvFromBTCSwapState = void 0;
 ...
 */
class SpvFromBTCSwapBase extends ISwap_js_1.ISwap {
    ...
    async txsClaim(_signer) {
        ...
        return await this._contract.txsClaim(address ?? this._getInitiator(), vaultData, withdrawalData.map(tx => {
            return { tx };
...
exports.SpvFromBTCSwapBase = SpvFromBTCSwapBase;
