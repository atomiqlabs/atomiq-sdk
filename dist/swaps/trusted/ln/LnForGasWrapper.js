...
const LnForGasSwap_js_1 = require("./LnForGasSwap.js");
 ...
 */
class LnForGasWrapper extends ISwapWrapper_js_1.ISwapWrapper {
    constructor() {
        super(...arguments);
         ...
         * @internal
         */
        this._swapDeserializer = LnForGasSwap_js_1.LnForGasSwap;
        /**
         * @internal
         */
        this._pendingSwapStates = [LnForGasSwap_js_1.LnForGasSwapState.PR_CREATED];
        /**
         * @internal
         */
    ...
    async create(recipient, amount, lpOrUrl) {
        ...
        const pricingInfo = await this.verifyReturnedPrice(typeof (lpOrUrl) === "string" || lpOrUrl.services[SwapType_js_1.SwapType.TRUSTED_FROM_BTCLN] == null ?
            { swapFeePPM: 10000, swapBaseFee: 10 } :
            lpOrUrl.services[SwapType_js_1.SwapType.TRUSTED_FROM_BTCLN], false, amountIn, amount, token, { swapFeeBtc: resp.swapFeeSats });
        const quoteInit = {
            pr: resp.pr,
        ...
        const quote = new LnForGasSwap_js_1.LnForGasSwap(this, quoteInit);
        return quote;
    }
}
