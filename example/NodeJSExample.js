...
var fs_storage_1 = require("crosslightning-sdk-base/dist/fs-storage");
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var swapper, signer, solanaSwapper;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    swapper = new dist_1.MultichainSwapper({
                        chains: {
                            SOLANA: {
                                rpcUrl: solanaRpc
                            }
                ...
                case 1:
                    _a.sent();
                    console.log(swapper);
                    signer = new crosslightning_solana_1.SolanaSigner(new crosslightning_solana_1.SolanaKeypairWallet(web3_js_1.Keypair.generate()));
                    ...
                    solanaSwapper.create(dist_1.Tokens.BITCOIN.BTCLN, dist_1.Tokens.SOLANA.SOL, new BN(10000), true).then(function (swap) {
